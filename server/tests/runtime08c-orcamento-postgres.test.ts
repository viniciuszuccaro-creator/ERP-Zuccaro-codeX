...
test('postgres orcamento lista com paginacao deterministica e itens sem N+1', async () => {
  ...
  assert.deepEqual(pageCall?.params, [scope.groupId, scope.empresaId, null, null, null, null, null, null, 10, 20]);
...
test('postgres orcamento get e list reutilizam executor fornecido', async () => {
  ...
  assert.deepEqual(supplied.calls[1].params, [scope.groupId, scope.empresaId, null, null, null, null, null, null]);
  assert.deepEqual(supplied.calls[2].params, [scope.groupId, scope.empresaId, null, null, null, null, null, null, 10, 0]);
});
