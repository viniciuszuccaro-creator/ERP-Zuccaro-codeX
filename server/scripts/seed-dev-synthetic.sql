...
-- A constraint DEFERRABLE valida condição ativa no commit; este conjunto deve
-- permanecer em uma única transação para nunca expor cabeçalho ativo sem parcelas.
BEGIN;
