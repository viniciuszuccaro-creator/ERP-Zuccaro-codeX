...
| C360-V1-06 | Backend HTTP de Pedido | C360-V1-05 | service, repositories, routes e metadata | CRUD permitido, status, cancelamento, conversao e historico com RBAC/auditoria | HTTP, seguranca, contratos e PG CI | exposicao sem RBAC; vazamento tenant | revert das rotas e composicao | CONCLUÍDO | neste checkpoint | pendente | rotas canonicas e R09 PostgreSQL incluidos |
